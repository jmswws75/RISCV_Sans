...
int run_stage_15b(int *Global_health) {
    ...
    for (int i = 0; i < 20; i++) {
        ...
        bone_army[i].posx[0] = (240 + 14 * i) << 8;
        bone_army[i].posx[1] = (240 + 14 * i) << 8;
        bone_army[i].posx[2] = (240 + 14 * i) << 8;
        ...
        bone_army[i+20].posx[0] = (240 + 14 * i) << 8;
        bone_army[i+20].posx[1] = (240 + 14 * i) << 8;
        bone_army[i+20].posx[2] = (240 + 14 * i) << 8;
