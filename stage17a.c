...
int run_stage_17a(int *Global_health) {
	...
	laundromat[0].posx[0] = (60) << 8;
	laundromat[0].posx[1] = (60) << 8;
	laundromat[0].posx[2] = (60) << 8;
	...
	laundromat[1].posx[0] = (320) << 8;
	laundromat[1].posx[1] = (320) << 8;
	laundromat[1].posx[2] = (320) << 8;
